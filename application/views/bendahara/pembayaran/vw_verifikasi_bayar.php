<div class="container-fluid">
     <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="<?= site_url('bendahara/home'); ?>">Dashboard</a>
        </li>
        <li class="breadcrumb-item">
            <a href="<?= site_url('bendahara/pembayaran'); ?>">Pembayaran</a>
        </li>
        ...
        <div class="col-md-12 ">
            <div class="card">
                <form action="" method="POST" class="form-horizontal form-label-left">
                    ...
                    <a href="<?= base_url('bendahara/pembayaran/') ?>" class="btn btn-danger">Tutup</a>
