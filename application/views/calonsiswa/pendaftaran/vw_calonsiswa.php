      ...
      <div class="card">
        ...
        <form action="<?= base_url('CalonSiswa/Pendaftaran/CalonSiswa/add'); ?>" method="POST"
          ...
          <div class="form-group">
            <label for="nama_lengkap">Nama Calon Siswa <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nik"required="required" type="text" placeholder="Masukkan NIK Anda..." value="<?= set_value('nik'); ?>">
            <small class="form-text text-muted"></small>
            <?= form_error('nik', '<small class="form-text text-danger">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="tempat_lahir">Tempat Lahir <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="tempat_lahir"required="required" type="text" placeholder="Masukkan tempat lahir anda..." value="<?= set_value('tempat_lahir'); ?>">
            <small class="form-text text-muted"></small>
            <?= form_error('tempat_lahir', '<small class="form-text text-danger">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="tanggal_lahir">Tanggal Lahir <span class="text-danger">*</span></label>
            <input type="date" class="form-control" name="tanggal_lahir"required="required" type="text" placeholder="Masukkan tanggal lahir anda..." value="<?= set_value('tanggal_lahir'); ?>">
            <small class="form-text text-muted"></small>
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control" name="cita-cita"required="required" type="text" placeholder="Masukkan Cita-Cita anda..." value="<?= set_value('cita-cita'); ?>">
            <small class="form-text text-muted"></small>
            <?= form_error('cita-cita', '<small class="form-text text-danger">', '</small>'); ?>
          </div>
           <div class="form-group">
            <label for="anak">Anak ke: <span class="text-danger">*</span></label>
            <input type="number" class="form-control" name="anak" required="required" type="text" placeholder="" value="<?= set_value('anak'); ?>">
            ...
            <div class="input-group">
              <input type="number" class="form-control" name="saudara" required="required" type="text" placeholder="Masukkan Jumlah Saudara  anda..." value="<?= set_value('saudara'); ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="alamat"required="required" type="text" placeholder="Masukkan alamat anda..." value="<?= set_value('alamat'); ?>">
            <small class="form-text text-muted"></small>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="number" class="form-control" name="waktu" required="required" type="text" placeholder="Masukkan waktu tempuh anda..." value="<?= set_value('waktu'); ?>">
              <div class="input-group-prepend">
