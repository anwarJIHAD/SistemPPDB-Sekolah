            ...
            <div class="card">
                <form action="" method="POST" class="form-horizontal form-label-left">
                    <div class="form-group">
                        <label for="pas_foto">Pas Foto <span class="text-danger">*</span></label>
                        <input class="form-control" type="file" name="pas_foto" value="<?= $dokumen['pas_foto']; ?>">
                        <small class="form-text text-muted">Foto scan pas foto. ukuran max
