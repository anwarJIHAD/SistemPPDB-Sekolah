            ...
            <div class="card">
                <form action="" method="POST" class="form-horizontal form-label-left">
                    <div class="form-group">
                        <label for="kip">KIP <span class="text-danger">*</span></label>
                        <input class="form-control" type="file" name="kip" value="<?= $dokumen['kip']; ?>">
                        <small class="form-text text-muted">Foto scan kKIP. ukuran max
