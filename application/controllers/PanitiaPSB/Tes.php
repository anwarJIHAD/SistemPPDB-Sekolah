...
class Tes extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('panitiapsb/tes/vw_tes', $data);
    ...
    public function lulus()
    {
        ...
        $this->load->view('panitiapsb/header', $data);
        $this->load->view('panitiapsb/tes/vw_lulus', $data);
        $this->load->view('panitiapsb/footer');
    }
    ...
    public function tidak_lulus()
    {
        ...
        $this->load->view('panitiapsb/header', $data);
        $this->load->view('panitiapsb/tes/vw_tidak_lulus', $data);
        $this->load->view('panitiapsb/footer');
    }
    ...
    public function belum_diverifikasi()
    {
        ...
        $this->load->view('panitiapsb/header', $data);
        $this->load->view('panitiapsb/tes/vw_verifikasi', $data);
        $this->load->view('panitiapsb/footer');
    }
    public function verifikasi($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view("panitiapsb/header", $data);
            $this->load->view("panitiapsb/tes/vw_ubah", $data);
